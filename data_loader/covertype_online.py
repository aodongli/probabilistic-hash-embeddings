...
class OnlineCoverData:
    ...
    def add_noise(self, data, ratio=0.3):
        ...
        label[flip_idx] = self.rng.randint(7, size=num_flip)
        data[:,-1] = label
        return data
    ...
    def get_all_task_info(self):
        ...
        self.init_task_ratio = 0.01 #0.03 #0.3
...
def main():
    ...
    db = OnlineCoverData('../data/tabular_data/covertype/', env_config=env_config)
    df = db.df
    print(df)
